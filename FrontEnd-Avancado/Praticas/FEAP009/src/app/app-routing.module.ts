...
import { ManejoSanitarioComponent } from './components/manejo-sanitario/manejo-sanitario.component';
import { ControlePorcosComponent } from './components/controle-porcos/controle-porcos.component';
...
const routes: Routes = [
  ...
  { path: 'controle-peso', component: ControlePesoComponent },
  { path: 'controle-porcos', component: ControlePorcosComponent},
];
