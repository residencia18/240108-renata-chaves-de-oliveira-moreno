...
import com.renatachom.springsecurity.controller.dto.CreateUserDto;
...
public class UserController {
    ...
    @GetMapping("/users")
    @PreAuthorize("hasAuthority('ADMIN')") // Restringe o acesso apenas para usuários com a role 'ADMIN'
